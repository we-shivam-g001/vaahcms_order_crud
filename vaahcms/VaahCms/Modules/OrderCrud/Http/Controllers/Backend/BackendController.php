...
class BackendController extends Controller
{
    ...
    public function index(Request $request)
    {
         ...
         */
        /*
        $permission_slug = 'has-access-ordercrud';
        ...
        */
        ...
        return view('ordercrud::backend.pages.app');
    ...
    public function getAssets(Request $request)
    {
        ...
        */
        ...
        $data['module'] = [
            'name' => config('ordercrud.name'),
            'version' => config('settings.global.ordercrud_version')??config('ordercrud.version'),
            'is_dev' => config('ordercrud.is_dev'),
        ];
